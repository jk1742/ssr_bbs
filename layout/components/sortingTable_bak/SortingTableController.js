...
const SortingTableController   = function (sortingTableHandler, headerInfo) {
   ...
   * @param {Page} page 
   */
  const appendTrAfter = function(page) {
    // sorting and fabricTableArray
		let arrTemp = fabricTableArray(page.rows, tableHeader);
		tableArrayData = mergeTableArrays(tableArrayData, arrTemp);
		// generate tbody
    tbody.generateRows(arrTemp, page);
  };
   ...
   * @param {Page} page 
   */
  const appendTrBefore = function(page) {
    // sorting and fabricTableArray
    let arrTemp = fabricTableArray(page.rows, tableHeader);
		tableArrayData = mergeTableArrays(arrTemp, tableArrayData);
		// generate tbody
    tbody.generateRvrsRows(arrTemp, page);
  };
  ...
  Object.assign(this, {
    ...
    updateTable (page) {
      ...
      // object to array
      const tempTableArray = fabricTableArray(page.rows, tableHeader);
      // sorting
